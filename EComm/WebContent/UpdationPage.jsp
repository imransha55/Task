...
.button1 {background-color: #bfff00;} 
.button2 {background-color: #40ff00;} 
.button3{background-color: #00ff00;}
.button4{background-color: #00ffbf;}
</style>
</head>
<body style="background: rgba(0, 128, 0, 0.3)">
<h1>What to Update</h1>
<a href="UpdateAdmin.jsp"><button class="button button1">Admin</button><br><br>
